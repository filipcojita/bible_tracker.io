...
<nav class="navbar navbar-expand-lg navbar-dark camp-navbar">
    <div class="container-fluid">
        <a class="navbar-brand" href="/dashboard/dashboard.php"><i class="bi bi-flag-fill me-2"></i> ACASĂ • Tabără 2027</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-center">
                <li class="nav-item">
                    <a class="nav-link<?= $activePage === 'dashboard' ? ' active' : '' ?>" aria-current="page" href="/dashboard/dashboard.php"><i class="bi bi-speedometer2"></i> Dashboard</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link<?= $activePage === 'scanner' ? ' active' : '' ?>" href="/dashboard/qr_scanner.php"><i class="bi bi-camera"></i> Scanner</a>
                </li>
            </ul>
